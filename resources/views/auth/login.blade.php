                ...
                <div class="card bg-secondary shadow border-0">
                    <div class="card-header bg-transparent pb-5">
                        ...
                        <div class="btn-wrapper text-center">
                            <a  href="{{url('redirect/github') }}"  class="btn btn-neutral btn-icon">
                                <span class="btn-inner--icon"><img src="{{ asset('argon') }}/img/icons/common/github.svg"></span>
                                <span class="btn-inner--text">{{ __('Github') }}</span>
                            </a>
                            <a href="{{url('redirect/facebook') }}"  class="btn btn-neutral btn-icon">
                                <span class="btn-inner--icon"><img src="https://upload.wikimedia.org/wikipedia/commons/5/51/Facebook_f_logo_%282019%29.svg"></span>
