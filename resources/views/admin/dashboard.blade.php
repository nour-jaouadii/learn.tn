    ...
    <div class="container-fluid mt--7">
        <div class="row">
            <div class="col-xl-8 mb-5 mb-xl-0">
                ...
                <h2 class="white" >Last Courses</h2>
                @if(count($courses))
                <div class="table-responsive dashbord_tracks">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <form action="{{ route('courses.destroy', $course) }}" method="post">
                                                    ...
                                                    onclick="confirm('{{ __("Are you sure you want to delete this Course?") }}') ? this.parentElement.submit() : ''">
                                                        {{ __('Delete') }}
                                                    </button>
                                                </form>    
                                            </div>
            ...
            <div class="col-xl-4">
                ...
                <h2 class="white" >Last Tracks</h2>
                @if(count($tracks))
                <div class="table-responsive dashbord_courses">
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                        ...
                        <tbody>
                            @foreach ($tracks as $track)
                                <tr>
                                    <td><a href="/admins/tracks/{{ $track->id }}">{{ $track->name }}</a></td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <form action="{{ route('tracks.destroy', $track) }}" method="post">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('tracks.edit', $track) }}">
                                                        {{ __('Edit') }}</a>
