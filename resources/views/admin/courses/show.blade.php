                    ...
                    <div class="card-header bg-white border-0">
                            ...
                            <div class="row the-course">
                              <div class="">
                                ...
                                <div class="col-sm">
                                    ...
                                    <h5><a href="/admins/tracks/{{ $course->track->id}} ">{{$course->track->name }} </a></h5>
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="card-header bg-white border-0">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <h3 class="mb-0">{{ __('Course Video') }}</h3>
                                    </div>
                                    <div class="col-4  text-right">
                                        <a href="/admin/courses/{{$course->id}}/videos/create" class="btn btn-sm btn-primary">
                                            {{ __('New Video') }}</a>
                                    </div>
                                    <div class="col-4  text-right">
                                        <a href="/admin/courses/{{$course->id}}/quizzes/create" class="btn btn-sm btn-primary">
                                            {{ __('New Quiz') }}</a>
                                    </div>
                                </div>
