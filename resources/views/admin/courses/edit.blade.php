        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('courses.update', $course->id) }}" autocomplete="off"
                        enctype="multipart/form-data">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="title" id="input-title"   value="{{$course->title}}"
                                    class="form-control form-control-alternative{{ $errors->has('title') ? ' is-invalid' : '' }}" 
                                    placeholder="{{ __('Title') }}" value="{{ old('name') }}"  
                                     required  autofocus>
                                ...
                                <div class="form-group{{ $errors->has('status') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="status" class="form-control" required>
                                         ...
                                         <option value="0" <?php if($course->status == '0' ) echo 'selected'; ?> >
                                            FREE </option>
                                         <option value="1" <?php if($course->status == '1' ) echo 'selected'; ?>
                                             >PAID</option>
                                ...
                                <div class="form-group{{ $errors->has('image') ? ' has-danger' : '' }}">
                                    ...
                                    class="form-control form-control-alternative{{ $errors->has('image') ? 
                                    ' is-invalid' : '' }}"  >
